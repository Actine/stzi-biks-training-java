...
public class VariablesApp {
    ...
    Класи описують не тільки структуру даних, але і операції - МЕТОДИ - які можна здійснювати над ними...

    ...Але в деталях про класи говоритимемо пізніше.

    ------------------------------------------------

    У переважній більшості мов ідентифікація одиниць даних здійснюється за допомогою ІМЕН.
...
//        System.out.println(emptyConstInt);       // видасть помилку
        ...
        System.out.println(10f);               // float - лише коли є суфікс f
        ...
        System.out.println(0xDEADC0DE);        // 3735929054 - шістнадцяткові починаються із 0x
